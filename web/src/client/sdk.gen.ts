 ...
 */
export const library = <ThrowOnError extends boolean = false>(options?: Options<LibraryData, ThrowOnError>): RequestResult<LibraryResponses, unknown, ThrowOnError> => (options?.client ?? client).get<LibraryResponses, unknown, ThrowOnError>({ url: '/api/library', ...options });
